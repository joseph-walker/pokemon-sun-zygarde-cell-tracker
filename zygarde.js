...
var _user$project$Main$jsonDecodeAqcuiredCells = function (_p0) {
	return A2(
...
var _user$project$Main$jsonEncodeAqcuiredCells = function (_p1) {
	return A2(
		...
		_elm_lang$core$Json_Encode$list(
			A2(
				...
				_elm_lang$core$Set$toList(_p1))));
};
var _user$project$Main$integerPercentage = F2(
	function (a, b) {
		return function (_p2) {
			return A3(
				_elm_lang$core$Basics$flip,
...
var _user$project$Main$viewCellCounter = F2(
	function (numCells, numAcquiredCells) {
		return {
			ctor: '::',
			_0: A2(
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'width',
									_1: A2(_user$project$Main$integerPercentage, numAcquiredCells, numCells)
								},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$acquiredCells = function () {
	var set = F2(
		function (val, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
	...
	return A2(
		_arturopala$elm_monocle$Monocle_Lens$Lens,
		function (_) {
			return _.acquiredCells;
		},
		set);
}();
var _user$project$Main$portSyncAcquiredCellsToLocal = _elm_lang$core$Native_Platform.outgoingPort(
	'portSyncAcquiredCellsToLocal',
	function (v) {
		return v;
	});
var _user$project$Main$syncAcquiredCellsToLocal = function (_p5) {
	return _user$project$Main$portSyncAcquiredCellsToLocal(
		_user$project$Main$jsonEncodeAqcuiredCells(_p5));
};
var _user$project$Main$update = F2(
	function (action, model) {
		...
		switch (_p6.ctor) {
			case 'ToggleCell':
				var _p7 = _p6._0;
				var method = A2(_elm_lang$core$Set$member, _p7, model.acquiredCells) ? _elm_lang$core$Set$remove : _elm_lang$core$Set$insert;
				var updatedModel = A2(
					_user$project$Main$acquiredCells.set,
					A2(method, _p7, model.acquiredCells),
					model);
				return A2(
					_Fresheyeball$elm_return$Return$command,
					_user$project$Main$syncAcquiredCellsToLocal(updatedModel.acquiredCells),
					_Fresheyeball$elm_return$Return$singleton(updatedModel));
			case 'SyncAcquiredCells':
				return A2(
					_Fresheyeball$elm_return$Return$map,
					_user$project$Main$acquiredCells.set(_p6._0),
					_Fresheyeball$elm_return$Return$singleton(model));
			default:
				return _Fresheyeball$elm_return$Return$singleton(model);
		}
	});
var _user$project$Main$portRequestSyncAcquiredCellsFromLocal = _elm_lang$core$Native_Platform.outgoingPort(
	'portRequestSyncAcquiredCellsFromLocal',
	function (v) {
		return v;
	});
var _user$project$Main$init = function (cells) {
	return A2(
		_Fresheyeball$elm_return$Return$command,
		_user$project$Main$portRequestSyncAcquiredCellsFromLocal(''),
		_Fresheyeball$elm_return$Return$singleton(
			{
				cells: _elm_lang$core$Array$fromList(cells),
				acquiredCells: _elm_lang$core$Set$empty
			}));
};
var _user$project$Main$portResponseSyncAcquiredCellsFromLocal = _elm_lang$core$Native_Platform.incomingPort('portResponseSyncAcquiredCellsFromLocal', _elm_lang$core$Json_Decode$string);
var _user$project$Main$Cell = F3(
	function (a, b, c) {
		return {thumbnail: a, location: b, notes: c};
	});
var _user$project$Main$Model = F2(
	function (a, b) {
		return {cells: a, acquiredCells: b};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$SyncAcquiredCells = function (a) {
	return {ctor: 'SyncAcquiredCells', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$portResponseSyncAcquiredCellsFromLocal(
		function (_p8) {
			return _user$project$Main$SyncAcquiredCells(
				_user$project$Main$jsonDecodeAqcuiredCells(_p8));
		});
};
...
var _user$project$Main$viewCell = F3(
	function (activeCellIndeces, index, cell) {
		var isActiveCellIndex = A2(_elm_lang$core$Set$member, index, activeCellIndeces);
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ToggleCell(index)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'checked', _1: isActiveCellIndex},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'thumb', _1: true},
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(cell.thumbnail),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$em,
						{
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'struck', _1: isActiveCellIndex},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(cell.location),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(cell.notes),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Zygarde Cell Checklist'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('cells'),
						_1: {ctor: '[]'}
					},
					_elm_lang$core$Array$toList(
						A2(
							_elm_lang$core$Array$indexedMap,
							_user$project$Main$viewCell(model.acquiredCells),
							model.cells))),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							_user$project$Main$viewCellCounter,
							_elm_lang$core$Array$length(model.cells),
							_elm_lang$core$Set$size(model.acquiredCells))),
					_1: {ctor: '[]'}
				}
			}
		});
						...
						return A2(
							...
							function (thumbnail) {
								return _elm_lang$core$Json_Decode$succeed(
									{location: location, notes: notes, thumbnail: thumbnail});
							},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Set.Set":{"args":["t"],"tags":{"Set_elm_builtin":["Dict.Dict t ()"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Main.Action":{"args":[],"tags":{"ToggleCell":["Int"],"SyncAcquiredCells":["Set.Set Int"],"NoOp":[]}}},"aliases":{},"message":"Main.Action"},"versions":{"elm":"0.18.0"}});
}
